...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--with-core=cobalt' '--enable-pshared' '--host=arm-linux-gnueabihf' '--build=arm' 'CFLAGS=-march=armv7-a -mfpu=vfp3' '--enable-dlopen-libs' 'build_alias=arm' 'host_alias=arm-linux-gnueabihf' 'CC=arm-linux-gnueabihf-gcc'"

/* Build system alias */
#define CONFIG_XENO_BUILD_STRING "arm-unknown-none"

/* config */
#define CONFIG_XENO_COBALT 1

/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 7.5.0 (Ubuntu/Linaro 7.5.0-3ubuntu1~18.04) "
...
/* config */
#define CONFIG_XENO_LIBS_DLOPEN 1
...
/* config */
#define CONFIG_XENO_REVISION_LEVEL 11
...
/* TLS model */
#define CONFIG_XENO_TLS_MODEL "global-dynamic"
...
/* config */
#define CONFIG_XENO_VERSION_STRING "3.0.11"
...
#define PACKAGE_STRING "Xenomai 3.0.11"
