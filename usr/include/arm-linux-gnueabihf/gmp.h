...
#define __GMP_CC "arm-linux-gnueabihf-gcc"
#define __GMP_CFLAGS "-g -O2 -fdebug-prefix-map=/build/gmp-vaLyDP/gmp-6.1.2+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security -O3"
